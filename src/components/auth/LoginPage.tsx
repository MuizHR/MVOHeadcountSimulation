...
export function LoginPage({ onLogin, onSwitchToSignUp, onBack, isLoading, error }: LoginPageProps) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to continue to JLG MVO Simulator</p>
          </div>
