...
export function SignUpPage({ onSignUp, onSwitchToLogin, onBack, isLoading, error }: SignUpPageProps) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign up to start using JLG MVO Simulator</p>
          </div>
